...
const resources = {
  en: {
    translation: {
      ...
      orders: {
        title: "Your Orders",
        description: "Check your order history and payment status",
        all: "All Orders",
        paid: "Paid",
        cashOnDelivery: "Cash on Delivery",
        search: "Search orders...",
        empty: "No orders yet",
        emptyPaid: "No paid orders yet",
        emptyCash: "No cash on delivery orders yet",
  ...
  ar: {
    translation: {
      ...
      cart: {
        ...
        viewCart: "عرض السلة",
        vendor: "البائع",
        emptyCart: "لا توجد منتجات في سلة التسوق.",
        ...
        failedToClearCart: "فشل إفراغ السلة",
        returnToShop: "العودة إلى المتجر",
      ...
      orders: {
        title: "طلباتك",
        description: "راجع سجل طلباتك وحالة الدفع",
        all: "كل الطلبات",
        paid: "مدفوع",
        cashOnDelivery: "الدفع عند الاستلام",
        search: "ابحث في الطلبات...",
        empty: "لا توجد طلبات بعد",
        emptyPaid: "لا توجد طلبات مدفوعة بعد",
        emptyCash: "لا توجد طلبات دفع عند الاستلام بعد",
